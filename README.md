...
毕业后在工作中也一点点积累前端知识，而且也会偶尔询问下公司的前端老哥一点技术问题，解决方案。直到在20-21年间读了张鑫旭大神的两本书，看了不少油管XX频道的视频，同时也有 Dribbble Dark 以及 PureTab 这两个项目的实践，觉得技术开始有点像样了，便开始动手重构整个网站。

抛弃 Boostrap 框架之后用上了 SaaS，以及 Flex 和 Grid 布局，起码自己看起来舒服多了。现在不管是访问速度、网站易用性、代码可读性等各方面均比以往更出色。Boostrap 那套 “col-md-12” 布局实在是难以接受，自己做的网站，不需要遵循第三方平台的规则，拥抱原生！

现在这个网站用来存放我的原创博客、设计作品等。之后还会做一个 Playground 页面，下一次技术进步的时候，会放上一些有意思的东西。现在网站还是很呆板的静态网站，暂时也没啥好办法，本人对后台、数据库的知识一窍不通，毕竟始终是一个 UI 设计师，我学习前端知识实际上也是为了赋能本职工作，其他的就坚持【不会、不学、不练】原则~
