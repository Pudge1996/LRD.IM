...
我们的下一步是进行[卡片分类](https://www.nngroup.com/articles/card-sorting-definition/)实验。我们为开发者提供大约 50 张卡片，每张卡片上都有一个文档或主题的名称。我们要求他们对这些卡片进行分类，将属于同一堆的卡片放到一堆中，然后给每一堆卡片命名。我们想看看人们在分类 Shopify 平台的信息中是否能找到相同的心智模型。
